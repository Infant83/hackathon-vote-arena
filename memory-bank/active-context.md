...
- `event-configs/2026_06_AIBD_REVERSE.json`: active `airever`, features `message`, `quiz`, default theme `pastel`, default font `vibe`
- `event-configs/2026_06_SCMAX_REVERSE.json`: active `scmax`, features `message`, `vote`, `quiz`, default theme `watercolor-coral`, default font `vibe`
